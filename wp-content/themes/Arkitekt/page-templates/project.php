     ...
     <div id="content">
          ...
          <div class="about_section gray-bg single-service">
          	   <div class="container ajax_posts">
                    <input type="hidden" id="include_filter_proj" name="include_filter_proj" value="0" />
                    ...
                    <div class="filter_section">
                        <div class="filter1">
                         	  <div id="button">
                                  ...
                                  <div class="the_menu">
                                           <ul>
                                            	<li class="change_view" viewtype="grid">Grid</li>
                                       ...
                                       $custom_terms = get_terms('categories_project');
										...
										foreach($custom_terms as $custom_term) {
											...
											$args = array('post_type' => 'projects',
											 ...
											 if($loop->have_posts()) {
												echo '<li class="cl_project" cid="'.$custom_term->term_id.'">'.$custom_term->name.'</li>';
											 }
										}
            ?>                           
