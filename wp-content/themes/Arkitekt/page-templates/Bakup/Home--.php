							 ...
							 ?>
                         	  <div class="col2_inner">
                              	   <div class="col2_inner_image">
										...
										$url_orinignal = the_post_thumbnail_url();
										 $url = img_resize($url_orinignal, 180, 234, true);
										?>
                              ...
                              <div class="col2_inner">
                              	   <?php if ( has_post_thumbnail() ) : 
									$url_orinignal = the_post_thumbnail_url();
									$url = img_resize($url_orinignal, 111, 347, true);
								   ?>
                        ...
                        <?php 	
					        ...
					        <?php setup_postdata($post); ?>
                              ...
                              <div class="col3_inner">
									...
									$url_orinignal =the_post_thumbnail_url();
									$url = img_resize($url_orinignal, 168, 111, true);
									 ?>
									<img src="<?php echo $url; ?>"  />
									<?php endif; ?>
                                   <div class="cases">
...
<?php endif; ?>
          ...
          <div class="section-gray home-section3">
               ...
               foreach( $vi as $post): // variable must be called $post (IMPORTANT) ?>
					        <?php setup_postdata($post); ?>
               		<div class="home_secion3_inner" data-postid="<?php echo get_the_ID();?>">
                    	<?php if ( has_post_thumbnail() ) : ?>
                         	  ...
                         	  <div class="video_table">
                              	   <div class="video_td">
                                   		<div class="video_text_inner">
                                             ...
                                             <p><?php the_content(); ?></p>
                                            <?php 
											if(get_field('vimeo_video_id',get_the_ID())){
												echo do_shortcode('[video_lightbox_vimeo5 video_id=196402158&rel=0 width=800 height=450 auto_thumb="0"]');
											}?>
                                        </div>
                                   </div>
                              </div>
