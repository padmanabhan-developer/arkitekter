                                     ...
                                     <!--<ul>
                                         ...
                                         <?php 
											...
											foreach($location as $loc) {
												echo '<li class="cl"  data-postid="'.get_the_ID().'" cid="'.get_the_title( $loc->ID ).'" type="loc">'.get_the_title( $loc->ID ).'</li>';
											}
										 ?>
                                         </ul>
                                  </div><!--close the_menu-->
		...
		$( ".cl" ).click(function() {
		  ...
		  var type = $(this).attr('type');
				$.ajax({
					...
					type:'POST',
					data:{state_id:state_id,postid:postid,type:type, action:'auto_search'},
