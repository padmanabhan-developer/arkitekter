          	   ...
          	   <div class="container">
               		<div id="grid2">
                        <div id="posts2">
							...
							if (get_sub_field('cases_images')) : 
							$imageURL = get_sub_field('cases_images');
							...
							$url = img_resize($imageURL, 352, 420, true);
							$divclass = 'case-big';
							}
							else{
							$url = img_resize($imageURL, 352, 205, true);
							}
							}
							else:
								continue;
							...
							{
								?><a href="<?php echo get_sub_field('cases_images'); ?>" class="cases_single_page" ><div class="layer"></div> </a>     
                                <?php
							}
							$co++;
							endwhile;
          	   ...
          	   <div class="container">
                    ...
                    <div class="about_right">
                      ...
                      <div class="faq">
                        ...
                        <?php if( have_rows('cases_gellery_2') ):?>      
                       	<div id="gallery_2">
                            <?php 
							$co2=1;
							while( have_rows('cases_gellery_2') ): the_row(); 
							$image = get_sub_field('galleryimages');
						
							if (get_sub_field('galleryimages')) : 
							$imageURL = get_sub_field('galleryimages');
							$imageBase = str_replace(basename($imageURL), '', $imageURL);
							$imageURLParts = parse_url($imageURL);
							$imagePath = $_SERVER['DOCUMENT_ROOT'] . $imageURLParts['path'];
							if (!is_file($imagePath)) 
								...
								$originalSize = getimagesize($imagePath);
								if($originalSize[1] > $originalSize[0]){
									$url = img_resize($imageURL, 310, 420, true);
									$divclass = 'case-big';
								}
								else{
									$url = img_resize($imageURL, 310, 205, true);
								}
							}
							else:
								continue;
                            ...
                            <div class="gallery">
                                <div class="case-inner">
                                <img src="<?php echo $url; ?>" alt="<?php echo $image['alt'] ?>" />
                                 <a href="<?php echo get_sub_field('galleryimages'); ?>" class="cases_single_page2" >    
                                     <div class="layer"></div>
                                 </a>    
                           		</div>
                        	</div><!--close post-->
