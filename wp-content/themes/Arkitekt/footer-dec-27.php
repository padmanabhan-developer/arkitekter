...
<div id="footer">
                    ...
                    <div class="col3 ftrbox2">
                         ...
                         <div class="social">
                         	  ...
                         	  <ul>
                              		...
                              		<li><a href="<?php echo $theme_option['lg_link_li']; ?>" class="linkein" target="_blank" ><img src="<?php echo $theme_option['footer_social_icon_star']['thumbnail']; ?>" title="Linkedin" /></a></li>
     ...
     <div class="footer_bottom">
          ...
          <?php  wp_nav_menu( array( 'menu' => 'footer', 'theme_location' => 'footer', 'items_wrap' => '<ul><li> </li>%3$s</ul>' ) ); ?>
