...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/contact-slider.css" type="text/css" />
...
//$term = get_term( 12, 'categories_project' );
//print_r($term);
$sector = mb_strtolower(str_replace(' ','',get_queried_object()->name));
?>
<div id="wrapper">
<header id="header" class="<?php echo get_the_ID();?>">
     	  <div class="container">
           	   <div class="logo">
               	...
               	<img class="headerlogo" src="<?php echo $theme_option['footer_llg']['url']; ?>" alt="" /></a></div>
               <nav id='cssmenu'>
                 ...
                 <?php if ( $parent_id == $item->menu_item_parent ): ?>
                  <?php if ( !$submenu ): $submenu = true; ?>
                    ...
                    <div class="container">
                        ...
                        $current = 0;
                        if($item->object == 'categories_project'){
                        $menu_title = mb_strtolower(str_replace(' ', '', $title));
                        	if($menu_title == $sector)    
								$current = 1;
                        }
						?>
                         	<li data-getid="<?php echo $post_slug;?>" data-postid="<?php echo $urlslug1;?> - <?php echo $post_slug;?>"  <?php if(($post_slug==$urlslug1) || ($current == 1)) {?>class="submenuactive" <?php } ?>>
                            <?php //print_r($item);?>

                            <a slug="<?php echo $item->title;?>" href="<?php if($link && $link !='#'){ echo $link; }else {?> javascript:; <?php }?>" class="title <?php echo $item->object_id;?> <?php echo get_the_ID()?>"><?php echo $title; ?></a>
                            </li>
                            <?php if(($submenucount > 1) && ($submenucount%3==0) ) echo "</ul><ul>";?>
                            <?php $submenucount++;?>
                            <?php if ( $menuitems[ $count + 1 ]->menu_item_parent != $parent_id && $submenu ): ?>
                        </ul>
                        <?php if($submenucount <=2) $height = 120;
						else if($submenucount == 3)$height = 137;
						else $height = 153;
						?>
                      ...
                      <div class="header_right">
                         ...
                         <div class="share_box">
                              ...
                              <div class="social_icons">
                              	   <a href="<?php echo $theme_option['lg_li_in']; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/inst.png"></a>
                                   <a href="<?php echo $theme_option['lg_link_li']; ?>" ><img src="<?php echo get_template_directory_uri(); ?>/images/ln.png"></a>
                                   <a href="<?php echo $theme_option['lg_li_fb']; ?>" ><img src="<?php echo get_template_directory_uri(); ?>/images/faceb.png"></a>
