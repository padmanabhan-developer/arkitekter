...
?>
 ...
 <?php $location = get_field( 'people_location', $post->ID );  ?>
                                          ...
                                          <div class="cases_table">
                                                ...
                                                <div class="cases_td">
                                                     ...
                                                     <div class="cases_text_inner">
                                                          ...
                                                          <h2><?php get_the_title($post->ID);  ?></h2>

                                                          <a href="<?php get_permalink($post->ID); ?>" class="button-with-arrow">læs mere</a>

                                                          <h6>England | London</h6>
				...
				<div class="post" data-postid="<?php echo get_the_ID();?>">
                                <div class="case-inner">
									<?php if ( has_post_thumbnail() ) : 
                                        ...
                                        <img src="<?php echo get_template_directory_uri();?>/images/default-project.jpg" alt="" />
									<?php 	endif; ?>
