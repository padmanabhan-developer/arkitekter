 ...
 if(count($posts_array) > 0){
	 foreach ( $posts_array as $post ) { 
		 ...
		 ?>
			...
			?>
            <tr class="serviceprojectrow"><td><?php echo get_the_date('d | m | Y',$post->ID); ?></td><td><?php echo get_the_title($post->ID); ?></td><td><?php echo the_field('location',$post->ID); ?></td></tr>
         	<?php
			 }
		 $nopost++;
		} 
