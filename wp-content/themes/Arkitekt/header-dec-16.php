     	  ...
     	  <div class="container">
               ...
               <div class="navbar navbar-default" role="navigation">
                        ...
                        <div class="navbar-collapse collapse">
                          ...
                          <!-- Right nav -->
                          <?php  wp_nav_menu( array( 'sub_menu' => true,  'walker' => new WPSE_78121_Sublevel_Walker , 'theme_location' => 'primary', 'items_wrap' => '<ul id="menu" class="nav navbar-nav navbar-right"><li class="dropdown yamm"> </li>%3$s</ul>' ) ); ?>
                      ...
                      <div class="header_right">
                         ...
                         <div class="share_box"><a class="share" style="background:rgba(0, 0, 0, 0) url(<?php echo $theme_option['sharechic']['thumbnail']; ?>) no-repeat scroll 0 0"></a></div>
