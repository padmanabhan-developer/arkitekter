				...
				(function ($) {
					...
					redux_pointer_options = $.extend(redux_pointer_options, {
						...
						buttons: function (event, t) {
							...
							button = jQuery('<a id="pointer-close" style="margin-left:5px" class="button-secondary">' + '<?php echo htmlspecialchars_decode( $button1 ); ?>' + '</a>');
					...
					setup = function () {
						...
						$('<?php echo htmlspecialchars_decode( $selector ); ?>').pointer(redux_pointer_options).pointer('open');

						<?php if ( $button2 ) { ?>

						jQuery('#pointer-close').after('<a id="pointer-primary" class="button-primary">' + '<?php echo htmlspecialchars_decode( $button2 ); ?>' + '</a>');

						jQuery('#pointer-primary').click(function () {

							<?php echo htmlspecialchars_decode( $button2_function ); ?>
						...
						jQuery('#pointer-close').click(function () {
							...
							<?php echo htmlspecialchars_decode( $button1_function ); ?>
