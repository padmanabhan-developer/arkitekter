    ...
    class ReduxFramework {
        ...
        public function show( $opt_name, $default = '' ) {
            ...
            if( !is_array( $option ) && $option != '' ) {
                ...
                echo htmlspecialchars_decode( $this->_get_default( $opt_name, $default ) );
...
//                $comparison = $field['required'][1];
        ...
        public function _options_page_html() {
            ...
            if( isset( $this->args['intro_text'] ) ) {
                ...
                echo htmlspecialchars_decode( $this->args['intro_text'] );
            ...
            foreach( $this->sections as $k => $section ) {
                ...
                echo htmlspecialchars_decode( $this->section_menu($k, $section) );             
            ...
            if( $this->args['system_info'] === true ) {
                ...
                echo htmlspecialchars_decode( $system_info->get( true ) );
                ...
                if( class_exists( $field_class ) ) {
                    ...
                    */
                    ...
                    if (!isset($field['fields']) || empty($field['fields'])) {
                        ...
                        echo htmlspecialchars_decode( $_render );
