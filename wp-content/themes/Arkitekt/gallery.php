          ...
          <div class="about_section">
          	   <div class="container">
               		<div class="about_left">
                    	 <h2><?php echo the_field('first_tab_title');?></h2>
                    </div>
                         	      ...
                         	      <section id="faq-list">
                                        ...
                                        <div class="faq_box">
                                            ...
                                            <div class="answer">
                                                 ...
                                                 <h3>Pabegyndt</h3>
                                                 <h4><?php echo the_field('pabegyndt'); ?></h4>
                                                 
                                                 <h3>Fardigbygget</h3>
                                                 <h4><?php echo the_field('fardigbygget'); ?></h4>
                                                 ...
                                                 <h4><?php echo the_field('samarbejdspartnere'); ?></h4>
