...
<div id="content">
          ...
          <div class="about_section gray-bg">
                ...
                <?php if( have_rows('image_gallery') && (have_rows('image_gallery_bottom_left')) && (have_rows('image_gallery_right'))) :
				?>
          ...
          <div class="container">
                ...
                <div class="container-infinite phone-show-section">
                    <div class="columns-2">
  						   <?php if( have_rows('image_gallery_right') ): 
                            $a1=1;
							while( have_rows('image_gallery_right') ): the_row(); 
                            	$image = get_sub_field('images');
								//print_r($image);
                            	 if($a1==1){
								 ?>
                                   <div class="phone-show-pro-big" style=" background-image: url(<?php echo $image; ?>);"></div>
                                   <?php }
								   if($a1==2){
								   ?>
                                    <div class="scene-graphs-big" style=" background-image: url(<?php echo $image; ?>);"></div>
                                    <?php }?>
                    ...
                    <div class="columns-2">
						   ...
						   <?php if( have_rows('image_gallery') ): 
							...
							while( have_rows('image_gallery') ): the_row(); 
                            	$image = get_sub_field('iamges');
                            	 if($b1==1){
								 ?>
                                   <div class="phone-show-pro-top" style=" background-image: url(<?php echo $image ?>);"></div>
                                   <?php }
								   if($b1==2){
								   ?>
                                    <div class="scene-graphs-top" style=" background-image: url(<?php echo $image ?>);"></div>
                                    <?php }?>
                        ...
                        <div class="img-wrap">
 						   <?php if( have_rows('image_gallery_bottom_left') ): 
                            $c1=1;
							while( have_rows('image_gallery_bottom_left') ): the_row(); 
                            	$image = get_sub_field('images');
								//print_r($image);
                            	 if($c1==1){
								 ?>
                                   <div class="phone-show-pro-bottom" style=" background-image: url(<?php echo $image; ?>);"></div>
                                   <?php }
								   if($c1==2){
								   ?>
                                    <div class="scene-graphs-bottom" style=" background-image: url(<?php echo $image; ?>);"></div>
                                    <?php }?>
                    ...
                    <div class="update-btn"><i class="i-upload"></i></div>
                </div>
            </div>
           </div>
            </div>
    ...
    <style>
        ...
        */
        ...
        .jssorb01 div a { background: rgba(0, 0, 0, 0) url("<?php echo get_template_directory_uri(); ?>/images/ic.png") no-repeat scroll 0 0;
			color: #fff;
			cursor: pointer;
			display: block;
			height: 10px;
			padding: 5px;
			width: 11px; }
        .jssorb01 div a:hover, .jssorb01 div.av a:hover { background-color: #d3d3d3; }
        .jssorb01 div.av a {  background: rgba(0, 0, 0, 0) url("<?php echo get_template_directory_uri(); ?>/images/ich.png") no-repeat scroll 0 0; }
        ...
        .jssora13l {
            ...
            height: 9px;
            cursor: pointer;
            background: url('<?php echo get_template_directory_uri(); ?>/images/prev.png') no-repeat;
            overflow: hidden;
        }
		.jssora13r {
            display: block;
            ...
            height: 9px;
            cursor: pointer;
            background: url('<?php echo get_template_directory_uri(); ?>/images/next.png') no-repeat;
            overflow: hidden;
        }
        .jssora13l { left:-15px; }
        .jssora13r { right:-20; }
