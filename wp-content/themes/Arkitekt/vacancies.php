     	  ...
     	  <div class="container">
          	   <div class="banner_inner">
				  ...
				  ?>
                    ...
                    <?php }else{
						if(get_field('banner_image',80)){
							$bannerimagem = get_field('banner_image',80); 
          	   ...
          	   <div class="container">
                    ...
                    <div class="news_header">
               	    ...
               	    <div class="news_single_left">
                    	 <div class="news_text single_contact_page">
                    	  <div class="single_news_image ">
                          <img src="<?php echo get_field('content_side_image'); ?>" alt="" /></div>
                          <?php
							the_content();
						  ?>
                         </div>
						 ...
						 if($file){
						 ?>
                         <span><a href="<?php echo $file; ?>" target="_blank" class="download">Download</a></span>
                         <?php }?>
                         <a href="<?php echo get_site_url()?>/job" class="button-with-arrow">Alle jobs</a>
