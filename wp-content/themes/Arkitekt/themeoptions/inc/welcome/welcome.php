    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['message'] = __( "Support hash could not be generated. Please try again later.", 'backyard' );
        ...
        public function admin_menus() {
            ...
            $page(
                ...
                __( 'Welcome to Redux Framework', 'backyard' ), __( 'Redux Framework', 'backyard' ), $this->minimum_capability, 'redux-about', array(
            ...
            $page(
                ...
                __( 'Redux Framework Changelog', 'backyard' ), __( 'Redux Framework Changelog', 'backyard' ), $this->minimum_capability, 'redux-changelog', array(
            ...
            $page(
                ...
                __( 'Get Support', 'backyard' ), __( 'Get Support', 'backyard' ), $this->minimum_capability, 'redux-support', array(
            ...
            $page(
                ...
                __( 'Redux Extensions', 'backyard' ), __( 'Redux Extensions', 'backyard' ), $this->minimum_capability, 'redux-extensions', array(
            ...
            $page(
                ...
                __( 'The people that develop Redux Framework', 'backyard' ), __( 'The people that develop Redux Framework', 'backyard' ), $this->minimum_capability, 'redux-credits', array(
            ...
            $page(
                ...
                __( 'Redux Framework Status', 'backyard' ), __( 'Redux Framework Status', 'backyard' ), $this->minimum_capability, 'redux-status', array(
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'backyard' ), $contributor->login ) )
