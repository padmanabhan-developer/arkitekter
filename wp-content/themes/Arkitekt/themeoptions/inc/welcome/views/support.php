<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
    ...
    <h1><?php _e( 'Redux Framework - Support', 'backyard' ); ?></h1>



    <div

        class="about-text"><?php printf( __( 'We are an open source project used by developers to make powerful control panels.', 'backyard' ), $this->display_version ); ?></div>
    ...
    <div id="support_div" class="support">
        ...
        <form id="supportform">
            ...
            <ul id="progressbar" class=" breadcrumb">
                ...
                <li class="active"><?php _e( 'Generate a Support URL', 'backyard' ); ?></li>

                <li href="#"><?php _e( 'Select Support Type', 'backyard' ); ?></li>

                <li href="#"><?php _e( 'How to Get Support', 'backyard' ); ?></li>
            ...
            <fieldset>
                ...
                <h2 class="fs-title"><?php _e( 'Submit a Support Request', 'backyard' ); ?></h2>



                <h3 class="fs-title"

                    style="margin-top:0;"><?php _e( 'To get started, we will need to generate a support hash.', 'backyard' ); ?></h3>



                <p><?php

                        echo sprintf( wp_kses( __( 'This will provide to your developer all the information they may need to remedy your issue. This action WILL send information securely to a remote server. To see the type of information sent, please look at the  <a href="%s">Status tab</a>.', 'backyard' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'tools.php?page=redux-status' ) ) );
            ...
            <fieldset>
                ...
                <h2 class="fs-title"><?php _e( 'Select Your Support Type', 'backyard' ); ?></h2>



                <h3 class="fs-subtitle" style="text-align: center;">

                    <?php _e( 'What type of user are you?', 'backyard' ); ?>
                ...
                <table id="user_type">
                    ...
                    <tr>
                        ...
                        <td id="is_user"><i class="el el-user"></i><br/><?php _e( 'User', 'backyard' ); ?><br/>

                            <small><?php _e( 'I am a user, using a pre-built product.', 'backyard' ); ?></small>

                        </td>

                        <td id="is_developer"><i

                                class="el el-github"></i><br/><?php _e( 'Developer', 'backyard' ); ?><br/>

                            <small><?php _e( 'I am a developer, building a product using Redux.', 'backyard' ); ?></small>
            ...
            <fieldset id="final_support">
                ...
                <h2 class="fs-title"><?php _e( 'How to Get Support', 'backyard' ); ?></h2>



                <div class="is_developer">

                    <p><?php _e( 'Please proceed to the Redux Framework issue tracker and supply us with your support URL below. Please also provide any information that will help us to reproduce your issue.', 'backyard' ); ?></p>
                ...
                <div class="is_user">
                    ...
                    <?php //echo $dirname; ?><!--"><strong>--><?php //_e( 'Plugin', 'backyard' );?>
                    ...
                    <?php //echo sanitize_html_class( $active_theme->Name ); ?><!--"><strong>--><?php //_e( 'Theme', 'backyard' ); ?>
                ...
                <p><em>
                        ...
                        <?php
                            ...
                            echo sprintf( wp_kses( __( 'Should the developer not be responsive, read the <a href="%s" target="_blank">following article</a> before asking for support from us directly.', 'backyard' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'http://docs.reduxframework.com/core/support-defined/' ) );
