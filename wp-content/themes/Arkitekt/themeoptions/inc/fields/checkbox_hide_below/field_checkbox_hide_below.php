...
if ( ! class_exists( 'ReduxFramework_checkbox_hide_below' ) ) {
    ...
    */
    function enqueue() {
		...
		wp_enqueue_style (
                    ...
                    ReduxFramework::$_url . 'inc/fields/checkbox_hide_below/field_checkbox_hide_below.css',
                    array(),
                    time (),
                    'all'
                );
        ...
        wp_enqueue_script (
                'field_checkbox_hide_below',
                ReduxFramework::$_url . 'inc/fields/checkbox_hide_below/field_checkbox_hide_below' . Redux_Functions::isMin () . '.js',
