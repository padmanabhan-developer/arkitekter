          	   ...
          	   <div class="container">
                    ...
                    <div class="news_header">
               	    ...
               	    <div class="news_single_left">
                    	 <div class="news_text">
                    	 <div class="single_news_image"><?php twentyfourteen_post_thumbnail('full'); ?></div>
                         <style>
						 .news_text .single_news_image .post-thumbnail .wp-post-image {
                         ...
                         <a href="#" class="button-with-arrow" onclick="next_post_link()">Alle nyheder</a>
                    ...
                    <div class="news_single_right">
						...
						?>
                         	<li><?php echo $trimmed_content; ?><br><?php the_time('d . m . Y') ?></li>
                            <?php endwhile; ?> 
                         </ul>
