		...
		$.ajax({
			...
			success: function (data) {
				...
				if (jsonData.status == 'success') {
					...
					setTimeout(function(){
						$projectGrid.append( $appengrid ).masonry( 'appended', $appengrid, true );},2500);

					setTimeout(function(){
						$loader.removeClass('service_loading_loader').html('<a class="loadmore navigation" href="javascript:;">Load flere</a>')},2500);
					}else{
