...
function vidbg_default_color_palette( $l10n ) {
	$l10n['defaults']['color_picker'] = array(
		'palettes' => array( '#FFF', '#3498db', '#e74c3c', '#374e64', '#2ecc71', '#f1c40f' ),
	);
	return $l10n;
}
...
function vidbg_initialize_footer() {
	if( is_page() || is_single() || is_home() && get_option( 'show_on_front') == 'page' ) {
		...
		$overlay_color_value = !empty($overlay_color) ? $overlay_color : '#FFF';
...
function vidbg_gettingstarted_page() {
	echo '<div class="wrap">';
		...
		echo '<p><code>[vidbg container=&quot;body&quot; mp4=&quot;#&quot; webm=&quot;#&quot; poster=&quot;#&quot; loop=&quot;true&quot; overlay=&quot;false&quot; overlay_color=&quot;#FFF&quot; overlay_alpha=&quot;0.3&quot; muted=&quot;false&quot;]</code></p>';
